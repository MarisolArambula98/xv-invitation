    ...
    return (
        <div className="date__container">
            ...
            <div className="extra-item">
                <h1 className='title'>Adem&aacute;s</h1>
                <div className="details-container">
                    <div className="pool-details">
                        <span className="detail-text">Alberca</span>
                        <img src={Pool} alt="" width={"30%"} />
                    </div>
                    <div className="mailbox-details">
                        <span className="detail-text">Buz&oacute;n de dinero</span>
                        <img src={Buzon} alt="Buzón de deseos" width={"30%"} />
                    </div>
                </div>

                {/* <div className="vestimenta"></div> */}
            </div>
        </div>
    );
};
